...
public class BackgroundWorker extends AsyncTask<String, Void, String>{
    ...
    protected String doInBackground(String... params) {
        ...
        String Login_url = "http://172.31.155.179/login.php";
        String Register_url = "http://172.31.155.179/register.php";
        String route_add_url = "http://192.168.178.20/route_add.php";
